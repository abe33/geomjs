...
(function() {
  ...
  $(document).ready(function() {
    var animate, animated, canvas, circle, context, cubicBezier, diamond, ellipsis, geometries, initUI, linearSpline, linearSplinePoints, mouseX, mouseY, options, polygon, pt, rectangle, render, requestAnimationFrame, stats, t, testers, triangle;
    stats = new Stats;
    stats.setMode(0);
