...
(function() {
  ...
  Point = (function() {
    ...
    Point.coordsFrom = function(x, y, strict) {
      var _ref;
      if (strict == null) {
        strict = false;
      }
    ...
    Point.prototype.coordsFrom = function(x, y, strict) {
      return Point.coordsFrom(x, y, strict);
    };
